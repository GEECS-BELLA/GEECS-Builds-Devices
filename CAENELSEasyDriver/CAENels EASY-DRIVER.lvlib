...
<Library LVVersion="20008000">
	...
	<Item Name="Public" Type="Folder">
		<Item Name="Close" Type="Folder">
			<Item Name="ED_Close.vi" Type="VI" URL="../ED_Close.vi"/>
		</Item>
		<Item Name="Configuration" Type="Folder">
			<Item Name="ED_MOFF.vi" Type="VI" URL="../ED_MOFF.vi"/>
			<Item Name="ED_MON.vi" Type="VI" URL="../ED_MON.vi"/>
			<Item Name="ED_MRESET.vi" Type="VI" URL="../ED_MRESET.vi"/>
		</Item>
		<Item Name="Initialize" Type="Folder">
			<Item Name="ED_Initialize.vi" Type="VI" URL="../ED_Initialize.vi"/>
		</Item>
		...
		<Item Name="Utility" Type="Folder">
			...
			<Item Name="ED_GetString.vi" Type="VI" URL="../ED_GetString.vi"/>
			<Item Name="ED_Verify_ACK.vi" Type="VI" URL="../ED_Verify_ACK.vi"/>
		</Item>
	</Item>
</Library>
